...
public class Main {
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        int age = 45;
        boolean isAGoodBoy = true;
        String textFrom2Primitives = "text" + 1.5;// <--- Edit this line
        String textFrom2Primitives2 = "His age is " + age + " " + isAGoodBoy;
    ...
    private static void exercise4() {
        ...
        // String allNumbers = endNumbers + middleNumbers + earlyNumbers;
