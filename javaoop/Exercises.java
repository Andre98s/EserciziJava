...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        for (int i = 0; i < studentNames.size(); i++){
            ...
            System.out.println("Studente: " + student.getName()+ " Age: " + student.getAge());
        }
    ...
    private static void exercise3() {
        ...
        List<String> studentNames = Arrays.asList("Alice", "Aragon", "Alex","Andrea");
        ...
        }for (int age : studentAges) { //ciclo for each per trovare l'età media
            sum += age;
        }
        double average = (double) sum / studentAges.size(); // formula per fermare il loop (il double tra parentesi indica che qualsiasi cosa sputa fuori trasformalo in double)
