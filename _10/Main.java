...
public class Main {
    ...
    private static void exercise1() {
        ...
        // se fuori è mite & vesto i pantaloncini oppure se fuori non è mite & non vesto i pantaloncini
    ...
    private static void exercise2() {
        ...
        if ((shoeType == "fancy") && (minAge && moneyNeed)){
            System.out.println("Come in");
        }else{
            System.out.println("stay out");
        }
        // non possiamo accedere per via dei soldi mancanti
        // Write your code here
    }
    ...
    private static void exercise3() {
        ...
        double ourTestScore = 8.0;
        double maxTestScore = 10.0;
        double forCentScore = ourTestScore / maxTestScore * 100;
        ...
        if(!isTestRetry){
            ...
            } else if(forCentScore >= 80){
                System.out.println("B");
            } else if(forCentScore >= 70){
                System.out.println("C");
            } else if(forCentScore >= 60){
