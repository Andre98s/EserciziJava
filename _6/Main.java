...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("value"  + " " + value + " " + ",value square root = " + " " + valueSquareRoot);
    ...
    private static void exercise2() {
        ...
        System.out.println("The higher value is= " + " " + maximumValue);
        System.out.println("The lowest value is= " + " " + minimumValue);
    ...
    private static void exercise3() {
        ...
        int totalMoney = 50;
        int costPerBurger = 9;
        System.out.println("In my wallet there are=" + totalMoney % costPerBurger + "Euros");
    ...
    private static void exercise4Bonus() {
        ...
        // Math.ceil arrotonda il nostro valore per eccesso
        System.out.println(ourValue + " after using ceiling=" + Math.ceil(ourValue));
        // Math.floor arrotonda il nostro valore per difetto
        System.out.println(ourValue + " after using floor=" + Math.floor(ourValue));
        // Math.round arrotonda al numero intero successivo al nostro valore
        System.out.println(ourValue + " after using round=" + Math.round(ourValue));
        // Math.pow eleva alla potenza designata ( in questo caso un quadrato "4.5 alla seconda")
        System.out.println(ourValue + " after using powerOf with the value of 2=" + Math.pow(ourValue, 2));
        // Math.pow, in questo caso un cubo
        System.out.println(ourValue + " after using powerOf with the value of 3=" + Math.pow(ourValue, 3));
        // Math.random genera un valore randomico da 0.1 a 1 del valore designato (colpi critici nei giochi xD)
